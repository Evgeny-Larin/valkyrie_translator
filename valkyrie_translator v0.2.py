...
while True:
    ...
    df["text"] = df.text.replace(special_dict2, regex=True)\
                        .replace(special_dict, regex=True)
    ...
    while True:
        ...
        if file_translated == '':
            ...
            df_done['text'] = df_done['text'].replace(dict_special, regex=True)\
                                             .replace(dict_special2, regex=True)\
